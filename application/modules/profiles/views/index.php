					...
					<tr>
						...
						<td class="p-0 text-center">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-menu">
                                        <a class="dropdown-item" href="<?=base_url();?>research/create-research-proposal">Update</a>
                                        <a class="dropdown-item" href="#">Delete</a>
                                        <a class="dropdown-item" href="#">Endorse Research</a>
                                        <a class="dropdown-item" href="#">Approve Research</a>
                                    </div>
						</td>
					</tr>
					<?php
